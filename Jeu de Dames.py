...
class MainWindow(QMainWindow):
   def __init__(self):
      ...
      self.new_game_action = QAction(QIcon("board-game-go.png"),"Nouvelle partie", self)
      ...
      self.load_action = QAction(QIcon("blue-folder-network-horizontal-open.png"),"Charger une partie", self)
      ...
      #Action 'Sauvegarder'
      self.save_action = QAction(QIcon("disk-return.png"),"Sauvegarder", self)
      ...
      self.previous_history = QAction(QIcon("a-magnifier-history.png"),"Afficher l'historique des déplacements d'une partie précédente", self)
      ...
      self.save_history = QAction(QIcon("a-magnifier--plus.png"),"Sauvegarder l'historique des déplacements", self)
      ...
      #Action 'Manuel'
      self.help_action = QAction(QIcon("book-question.png"),"Obtenir de l'aide", self)
      ...
      #Action 'À  propos'
      self.aboutus_action = QAction(QIcon("a-user-silhouette-question.png"),"À propos", self)
      ...
      #Action 'Bleu'
      self.theme_ocean = QAction(QIcon("a-blue-flag.png"),"Thème Bleu Océan", self)
      self.theme_ocean.triggered.connect(self.changeThemeO)
      self.menu_theme.addAction(self.theme_ocean)

      #Action 'Rouge'
      self.theme_lava = QAction(QIcon("a-red-flag.png"), "Thème Rouge Lave", self)
      self.theme_lava.triggered.connect(self.changeThemeL)
      self.menu_theme.addAction(self.theme_lava)

      #Action 'Violet'
      self.theme_candy = QAction(QIcon("a-flag-pink.png"), "Thème Rose Bonbon", self)
